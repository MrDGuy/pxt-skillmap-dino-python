...
![Code a Collector Game](/static/img/collector/collectort1.gif "Grab the baby before it runs away!" )
...
![The background gallery](/static/img/dino-scene.gif "Toggle between editor and gallery" )
hint~
...
<!-- ![This is where the gallery is located](/static/img/assets/gallery.png "You can switch over to the gallery or make your own image." ) -->
![Choose the freeway from My Assets gallery](/static/img/freeway.png " " )
...
![The background gallery](/static/img/choose-bg.gif "Toggle between editor and gallery" )
hint~
...
![Look for the game window in the lower right](/static/img/assets/game-window.png "Click the mini game window to pop open the bigger game window.")
...
![Add the sprite block.](/static/img/dino1-5.gif "Add a sprite to your game.")
...
![My Assets tab](/static/img/assets/my-assets-three.png )


- :mouse pointer: Choose **Mama** and click **Done**.

![Choose mama dino from My Assets gallery](/static/img/mama-dino.png " " )
...
![Look in My Assets for Mama Dino](/static/img/dino1-6.gif )
...
![Look under Controller for the block](/static/img/dino1-7.gif "Drag out the controller block to use later.")
...
![Add a scroller block](/static/img/dino1-8.gif )
...
![Choose the baby dino from My Assets gallery](/static/img/baby.png " " )
...
![Add baby dinos](/static/img/dino1-10.gif )
...
![Share your card](/static/img/share.gif )
