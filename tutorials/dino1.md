...
![Code a Collector Game](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/collector/collectort1.gif "Grab the baby before it runs away!" )
...
![The background gallery](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/dino-scene.gif "Toggle between editor and gallery" )
hint~
...
![Choose the freeway from My Assets gallery](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/freeway.png " " )
...
![The background gallery](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/choose-bg.gif "Toggle between editor and gallery" )
hint~
...
![Look for the game window in the lower right](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/assets/game-window.png "Click the mini game window to pop open the bigger game window.")
...
![Add the sprite block.](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/dino1-5.gif "Add a sprite to your game.")
...
![My Assets tab](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/assets/my-assets-three.png )


- :mouse pointer: Choose **Mama** and click **Done**.

![Choose mama dino from My Assets gallery](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/mama-dino.png " " )
...
![Look in My Assets for Mama Dino](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/dino1-6.gif )
...
![Look under Controller for the block](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/dino1-7.gif "Drag out the controller block to use later.")
...
![Add a scroller block](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/dino1-8.gif )
...
![Choose the baby dino from My Assets gallery](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/baby.png " " )
...
![Add baby dinos](https://github.com/MrDGuy/pxt-skillmap-dino-python/blob/master/img/dino1-10.gif )
